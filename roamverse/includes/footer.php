...
<body>
  ...
  <footer class="footer-distributed">
    ...
    <div class="footer-icons">
      ...
      <a href="https://github.com/jassranouta/RoamVerse"><i class="fab fa-github"></i></a>
    </div>
    <hr>
    <p class="footer-company-name"><strong>RoamVerse &copy; 2024</strong></p>
  </footer>
</body>
